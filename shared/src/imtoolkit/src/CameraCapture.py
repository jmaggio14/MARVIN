...
class CameraCapture(Payload):
    ...
    def __init__(self,cam=0,fourcc="MJPG"):
        ...
        self.__changeable_settings_dict = {
    ...
    def change_setting(self,setting,value):
        ...
        return::
            None
        """
        if setting in self.__changeable_settings_dict.keys():
            flag = self.__changeable_settings_dict[setting]
            if flag == "foucc":
            ...
            raise ValueError("settings must be one of {0}"
                        .format(self.__changeable_settings_dict.keys()))
