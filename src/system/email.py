...
#     def __init__(self,subject,recipients,sender='jmaggio14@gmail.com'):
...
#         if typeCheck(attachments,(tuple,list)):
#             msg = self.__attach(msg,attachments)
#
#     def __attach(self,msg,attachments):
